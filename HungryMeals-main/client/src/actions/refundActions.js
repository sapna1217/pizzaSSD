...
export const addRefund = (refund)=>async dispatch=>{
    ...
    try{
        const response= await axios.post('http://localhost:8070/api/refunds/addrefund', {refund})
...
export const getAllRefunds = ()=>async dispatch=>{
    ...
    try{
        const response= await axios.get('http://localhost:8070/api/refunds/getallrefunds')
        console.log(response);
...
export const updateStatusAction = (updatestatus, refundid, val) => async dispatch => {
    ...
    if (val === true) {
        ...
        try {
            const response = await axios.put(`http://localhost:8070/api/refunds/update/pendingrefund/${refundid}`, updatestatus)
...
export const deleteRefundTransactionAction = (refundid) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8070/api/refunds/delete/Refund/${refundid}`)
