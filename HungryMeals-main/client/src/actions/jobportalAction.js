...
export const getAllJobs = () => async dispatch => {
    ...
    try {
        ...
        const response = await axios.get('http://localhost:8070/api/jobportal/getalljobs')
...
export const deleteJobAction = (JobID) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8070/api/jobportal/delete/jobs/${JobID}`)
...
export const addJob = (job) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/jobportal/post/jobs', job)
        console.log(response);
...
export const updateJobsAction = (updatejobs, id) => async dispatch => {
    ...
    try {
        ...
        const response = await axios.put(`http://localhost:8070/api/jobportal/update/jobs/${id}`, updatejobs)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
