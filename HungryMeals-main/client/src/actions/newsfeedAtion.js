...
export const getAllNews = () => async dispatch => {
    ...
    try {
        ...
        const response = await axios.get('http://localhost:8070/api/newsfeed/getallnews')
...
export const createNewsAction = (newNews) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/newsfeed/post/news',newNews )
...
export const updateNewsAction = (updatenews, id) => async dispatch => {
    ...
    try {
        ...
        const response = await axios.put(`http://localhost:8070/api/newsfeed/update/news/${id}`, updatenews)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
...
export const deleteNewsAction = (newsId) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8070e/news/${newsId}`)
