...
export const loginAdmin = (admin) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/admins/login', admin)
...
export const addAdmin = (admin) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/admins/addAdmin', admin)
        console.log(response);
...
export const deleteAdminAction = (adminID) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8070/api/admins/delete/admin/${adminID}`)
