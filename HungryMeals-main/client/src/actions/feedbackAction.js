...
export const UserFeedBack = (newFeedback) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/feedback/post',newFeedback )
...
export const deletefeedbackAction = (userId) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8070/api/feedback/delete/feedback/${userId}`)
...
export const updateDisplayFeedback = (updateDisplayFeedback, userId, val) => async dispatch => {
    ...
    if (val === true) {
        ...
        try {
            const response = await axios.put(`http://localhost:8070/api/feedback/update/feedback/display/${userId}`, updateDisplayFeedback)
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
        ...
        try {
            const response = await axios.put(`http://localhost:8070/feedback/display/${userId}`, updateDisplayFeedback)
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
...
export const updateReplyMessageAction = (updateReplyMassage, userId) => async dispatch => {
    ...
    dispatch({ type: 'DISPLAY_CUSTOMER_FEEDBACK_REQUEST' })
        ...
        try {
            const response = await axios.put(`http://localhost:8070/api/feedback/update/reply/${userId}`, updateReplyMassage)
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
                showConfirmButton: false,
