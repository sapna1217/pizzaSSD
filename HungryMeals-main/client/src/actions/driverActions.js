...
export const loginDriver = (driver) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/delivery/login', driver)
...
export const updateDeliveryStatus = (updateisDeliveryAccepted, orderId , val) => async dispatch => {
    ...
    if(val === true){
        ...
        try {
            const response = await axios.put(`http://localhost:8070/api/delivery/update/status/delivery/${orderId}`, updateisDeliveryAccepted)
...
export const newDeliveryAction = (newDelivery) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/delivery/post/delivery',newDelivery )
