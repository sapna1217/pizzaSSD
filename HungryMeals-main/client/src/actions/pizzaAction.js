...
export const addFoodsAction = (newFoods) => async dispatch => {
    ...
    try {
        const response = await axios.post('http://localhost:8070/api/pizzas/add/food',newFoods )
...
export const getAllPizzas = () => async dispatch => {
    ...
    try {
        ...
        const response = await axios.get('http://localhost:8070/api/pizzas/getallpizzas')
        console.log(response)
...
export const updateFoodsAction = (updatefoods, id) => async dispatch => {
    ...
    try {
        ...
        const response = await axios.put(`http://localhost:8070/api/pizzas/update/food/${id}`, updatefoods)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
...
export const deleteFoodsAction = (foodId) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`http://localhost:8070food/${foodId}`)
