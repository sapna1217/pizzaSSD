...
export const updateUserName = (updatename, id) => async dispatch => {
    ...
    try {
        const response = await axios.put(`http://localhost:8070/api/users/update/name/${id}`, updatename)
...
export const updateUserEmail = (updateemail, id) => async dispatch => {
    ...
    try {
        const response = await axios.put(`http://localhost:8070/api/users/update/email/${id}`, updateemail)
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
...
export const updateNotificationOneAction = (updateNotificationOne, userId) => async dispatch => {
    ...
    try {
        ...
        const response = await axios.put(`http://localhost:8070/api/users/update/notificationOne/${userId}`, updateNotificationOne)
...
export const updateNotificationTwoAction = (updateNotificationTwo, userId) => async dispatch => {
    ...
    try {
        const response = await axios.put(`http://localhost:8070/api/users/update/notificationTwo/${userId}`, updateNotificationTwo)
...
export const updateNotificationThreeAction = (updateNotificationThree, userId) => async dispatch => {
    ...
    try {
        const response = await axios.put(`http://localhost:8070/api/users/update/notificationThree/${userId}`, updateNotificationThree)
...
export const updateNotificationFourAction = (updateNotificationFour, userId) => async dispatch => {
    ...
    try {
        const response = await axios.put(`http://localhost:8070/api/users/update/notificationFour/${userId}`, updateNotificationFour)
