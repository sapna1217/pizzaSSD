...
export const setNotification = () => async dispatch => {
    ...
    try {
        const response = await axios.get('http://localhost:8070/api/notifications/getnotifications')
...
export const updateNotificationAction = (updateNotification) => async dispatch => {
    ...
    try {
        const response = await axios.put('http://localhost:8070/api/notifications/update/notification/63c378651e3467b26e947c1c', updateNotification)
