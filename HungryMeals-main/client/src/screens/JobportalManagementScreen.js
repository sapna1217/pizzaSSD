...
function JobportalManagementScreen() {
    ...
    //         axios.get("http://localhost:8070/api/jobportal/getalljobs").then((res) => {
    //             setJobs(res.data);
    ...
    useEffect(() => {
        function getJobs() {
            axios.get("http://localhost:8070/api/jobportal/getalljobs")
                .then((res) => {
                    setJobs(res.data);
    ...
    function getCurrentJobs(jobId) {
        ...
        axios.get(`http://localhost:8070/api/jobportal/getcurrentjobs/${jobId}`).then((res) => {
